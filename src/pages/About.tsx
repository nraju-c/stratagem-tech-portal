...
>
  ...
  style={{
    backgroundImage: "url('https://qsort.blob.core.windows.net/media/AboutUsMainF.jpg')"
  }}
>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-12">
            ...
            <div className="text-center">
              ...
              <h2 className="text-2xl font-bold text-white mb-4 font-dind">Our Mission</h2>
            ...
            <div className="text-center">
              ...
              <h2 className="text-2xl font-bold text-white mb-4 font-dind">Our Vision</h2>
              <p className="text-gray-300 leading-relaxed">
            ...
            <div className="text-center">
              ...
              <h2 className="text-2xl font-bold text-white mb-4 font-dind">Our Values</h2>
              <p className="text-gray-300 leading-relaxed">
      ...
      <section className="py-20">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            <h2 className="text-3xl md:text-4xl font-bold text-white mb-4 font-dind">Our Core Values</h2>
                ...
                <Card key={index} className="bg-slate-700/30 border-slate-600 hover:border-blue-500/50 transition-all duration-300">
                  <CardContent className="p-8">
                    <div className="flex items-start space-x-4">
                      ...
                      <div>
                        <h3 className="text-xl font-semibold text-white mb-3 font-dind">{value.title}</h3>
